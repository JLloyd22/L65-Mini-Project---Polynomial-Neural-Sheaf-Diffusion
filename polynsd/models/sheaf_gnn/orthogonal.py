...
#TODO: uniform the usage of Orthogonal class across the codebase, e.g. in utils/linalg.py we have cayley redefined.
#TODO: or eventually remove this file and use only utils/linalg.py, or refactor this thing since we only use householder or cayley sometimes...
class Orthogonal(nn.Module):
    ...
    def forward(self, params: torch.Tensor) -> torch.Tensor:
        ...
        if self.orthogonal_map == "matrix_exp" or self.orthogonal_map == "cayley":
            ...
            Q = torch_householder_orgqr(A)  # householder_orgqr(A)

...
from polynsd.models.sheaf_gnn import laplacian_builders as lb
from polynsd.models.sheaf_gnn.config import ODEArguments
...
class ODEBlock(nn.Module):
    ...
    def __init__(self, odefunc, t, opt: ODEArguments):
...
class GraphLaplacianDiffusion(SheafDiffusion):
    ...
    def __init__(self, edge_index, args):
        ...
        self.odeblock = ODEBlock(self.odefunc, self.time_range, args.ode_args)
...
class BundleSheafDiffusion(SheafDiffusion):
    ...
    def get_param_size(self):
        if self.orth_trans in ["matrix_exp", "cayleyopt"]:

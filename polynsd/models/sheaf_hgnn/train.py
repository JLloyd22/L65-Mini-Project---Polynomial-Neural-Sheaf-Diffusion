...
from polynsd import models
from convert_datasets_to_pygDataset import dataset_Hypergraph
from polynsd.models.hgnn_baselines import (
    CEGAT,
    CEGCN,
    HCHA,
    HNHN,
...
if __name__ == "__main__":
    ...
    # Args for Sheaves
    parser.add_argument(
        "--init_hedge", default="rand", type=str, choices=["rand", "avg"]
    )
    parser.add_argument(
    ...
    if args.method in [
        ...
        "LowRankSheafsDiffusion",
        "SheafEquivSetGNN_LowRank",
    ]:
    ...
    print(
        f"TIME FOR ONE EXPERIMENT WITH {args.runs} RUNS: \\ Minutes: {total_time // 60}, seconds {total_time % 60}"
    )
